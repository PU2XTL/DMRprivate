...
BRIDGES = {
    'HBLink-Peer-TG13': [
            {'SYSTEM': 'MASTER-1',            'TS': 2, 'TGID': 13,       'ACTIVE': True,  'TIMEOUT': 30, 'TO_TYPE':'NONE',  'ON': [11],       'OFF': [55],    'RESET': []},
        ],
    'HBLink-EchoTest-TG9999': [
            {'SYSTEM': 'ECHOTEST',            'TS': 2, 'TGID': 9999,     'ACTIVE': True,  'TIMEOUT': 1,  'TO_TYPE':'OFF', 'ON': [],         'OFF': [],      'RESET': []},
            {'SYSTEM': 'MASTER-1',            'TS': 2, 'TGID': 9999,     'ACTIVE': True,  'TIMEOUT': 1,  'TO_TYPE':'OFF', 'ON': [],         'OFF': [],      'RESET': []},
        ]
}
